#!/bin/bash
# 通过 rjob 提交 brain2qwerty v2 BrainOmni 训练任务
...
do
    job_name="brain2qwerty-v2-brainomni-seed${seed}-$(date +%Y%m%d-%H%M%S)"
    rjob submit \
        --name=$job_name \
        --gpu=4 \
        --memory=480000 \
        ...
        -- bash -exc /mnt/shared-storage-user/xiaoqinfan/brain2qwerty/script/brain2qwerty_v2_brainomni/train.sh
done
