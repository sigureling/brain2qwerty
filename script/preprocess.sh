...
echo "[preprocess] 开始预处理: python -m brain2qwerty_v2.main cache ${MODE_ARGS[*]:-}"
python -m brain2qwerty_v2.main cache "${MODE_ARGS[@]}" 2>&1 | tee "$LOG_FILE"
